<?php include 'init.php'; 
      ...
      $stmt = $con->prepare("SELECT * FROM slides ORDER BY id DESC");
      $stmt->execute();
      $rows = $stmt->fetchAll();  ?>
				...
				<div class="app-content">
					<section class="section">
                    	<ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">إدارة البنرات</li>				 
                        </ol>
									...
									<div class="card-body">
                                        <div class="row" dir="rtl" >
                                            <div class="col-lg-4 text-right" >
                                                <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#slide" > اضافة بانر </button>
                                            </div>
                                        </div>
												...
												<tbody> 
													...
													<tr> 
														...
														<td><?php echo $cat['url']; ?></td>
 														<th class="wd-15p"> 
                                                            <a href="slides-edit.php?id=<?php echo $cat['id'] ?>" class="btn btn-success" ><i class="fa fa-edit" ></i></a>
