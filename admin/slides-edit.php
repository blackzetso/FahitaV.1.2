<?php include 'init.php'; 
      ...
      $stmt = $con->prepare("SELECT * FROM slides WHERE id = ? ");
      $stmt->execute([$id]);
      $row = $stmt->fetch();
                                            ...
                                            <div class="col-12" >
                                                <div class="form-group text-center">
                                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#image-edit" >
                                                        <img style="width:300px;width:300px;" src="../img/slides/<?php echo $row['img']; ?>" >
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row text-right" dir="rtl" >  
                                                <div class="col-md-6 col-sm-12" >
                                                    <div class="form-group text-right" >
                                                        ...
                                                        <input type="number" class="form-control text-right" value="<?php echo $row['number'] ?>" dir="rtl" name="number"required > 
                                                    </div>
                                                </div>
