				...
				<div class="app-content">
					<section class="section">
                    	<ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">إدارة الماركات</li>				 
                        </ol>
									...
									<div class="card-body">
                                        <div class="row" dir="rtl" >
                                            <div class="col-lg-4 text-right" >
                                                <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#addCategory" >اضافة ماركة</button>
                                            </div>
                                        </div>
											...
											<table id="example" class="table table-striped text-center table-bordered border-t0 w-100 text-nowrap">
												...
												<tbody>
													...
													<tr>
                                                        ...
                                                        <td>
                                                            <img height="50px" width="50px" src="../img/brand/<?php echo defaultBrand($cat['image']); ?>" >
                                                        </td>
														<td><?php echo $cat['name']; ?></td> 
														<th class="wd-15p">  
                                                            <a href="brand-edit.php?id=<?php echo $cat['id']; ?>" class="btn btn-success" ><i class="fa fa-edit" ></i> </a>
