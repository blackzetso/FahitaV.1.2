									...
									<div class="card-body">
                                        ...
                                        <form id="edit" >
                                            ...
                                            <div class="row text-right" dir="rtl" >  
                                                <div class="col-md-12 col-sm-12" >
                                                    <div class="form-group text-right" >
                                                        <label for="recipient-name" class="form-control-label " dir="rtl"> ترتيب : <span class="text-danger" >*</span></label>
                                                        <input type="number" class="form-control text-right" value="<?php echo $row['category_order'] ?>" dir="rtl" name="order" required > 
                                                    </div>
                                                </div> 
                                            </div> 
                                            <div class="form-group text-right" >
