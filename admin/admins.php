<?php include 'init.php'; 
      ...
      $stmt = $con->prepare("SELECT * FROM users WHERE permission = 'admin' ORDER BY id DESC");
      $stmt->execute();
      $rows = $stmt->fetchAll();
 ?>
				...
				<div class="app-content">
					<section class="section">
                    	<ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">إدارة المسؤولين</li>				 
                        </ol>
						...
						<form id="delForm" >
                            <div class="modal-content ">  
                                <div class="modal-body text-right" dir="rtl">
                                     <p class="mb-0">هل أنت متأكد من حذف هذا المسؤل ؟</p>
                                </div><!-- modal-body -->
