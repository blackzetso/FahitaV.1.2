                                ...
                                <table class="shop_table">
                                    ...
                                    <tr class="cart_item "> 
                                        ...
                                        <td class="product-name text-center" style="text-align: center !important;" data-title="Product">
                                            <a href="order_itmes.php?id=<?php echo $orderItems['item_id']; ?>" class="title"><?php echo $product['name']; ?></a> 
                                        </td>
                                        <td class="product-quantity" data-title="Quantity">
                                            <div class="quantity">
                                                <div class="control">
                                                     
                                                    <input type="text" data-step="1" disabled data-min="0" value="<?php echo $item['qty']; ?>" title="Qty"
