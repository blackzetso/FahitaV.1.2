                        ...
                        <ul class="gnash-nav-vertical vertical-menu gnash-clone-mobile-menu">
                            ...
                            <li class="menu-item menu-item-has-children">
                                ...
                                <ul role="menu" class=" submenu">
                                    ...
                                    <li class="menu-item">
                                        <a title="New Arrivals" href="#" class="gnash-item-title">New Arrivals</a>
                                    </li>
                                    <li class="menu-item">
                    ...
                    <div class="container-wapper">
                        <ul class="gnash-clone-mobile-menu gnash-nav main-menu " id="menu-main-menu">
                            ...
                            <li class="menu-item  menu-item-has-children">
                                ...
                                <ul class="submenu">
                                    <li class="menu-item menu-item-has-children">
                                        <a href="#" class="gnash-menu-item-title" title="Blog Style">Blog Style</a>
                                        <span class="toggle-submenu"></span>
                                        <ul class="submenu">
                                            <li class="menu-item">
                                    ...
                                    <li class="menu-item menu-item-has-children">
                                        <a href="#" class="gnash-menu-item-title" title="Post Layout">Post Layout</a>
                                        <span class="toggle-submenu"></span>
                                        <ul class="submenu">
                                            <li class="menu-item">
